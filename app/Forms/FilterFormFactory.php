...
class FilterFormFactory
{
	...
	{
		return $this->sessionSection->values;
	}

	public function addFieldParameter($key, $item)
	{
		$this->fieldParameters[$key] = $item;
	}
	...
	public function create(callable $onSubmit)
	{
		...
		$form->addSubmit('send', 'Send')->setAttribute("class", "filterButton");
