...
class Control extends Application\UI\Control
{
	 ...
	 */
         ...
         * @var array 
         */
        protected $listPerPage = [30=>30,60=>60,90=>90];
        
        /*
         * Set array with list of numbers
         */
        ...
        public function getItemsPerPage(){
            if ($this->perPage == null) {
                foreach ($this->listPerPage as $key=>$item){                    
                    return $key;
                }                
        }else{
            return $this->perPage;
	...
	public function render()
	{
		...
		if ($this->template instanceof Nette\Bridges\ApplicationLatte\Template) {
			...
			$this->template->useAjax	= $this->useAjax;
                        $this->template->listPerPage    = $this->listPerPage;
                        $this->template->perPage        = $this->getItemsPerPage();
